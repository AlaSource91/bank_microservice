...
CREATE TABLE outbox_events (
    ...
    aggregate_id VARCHAR(255) NOT NULL COMMENT 'ACCOUNT_ID ID',
    aggregate_type VARCHAR(100) NOT NULL COMMENT 'BANK_ACCOUNT',
    event_type VARCHAR(100) NOT NULL COMMENT 'CREATE / UPDATE /FROZEN /DELETE',
