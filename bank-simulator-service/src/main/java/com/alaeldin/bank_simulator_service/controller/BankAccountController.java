 ...
 * Provides endpoints for creating, retrieving, updating, and managing bank accounts.
 *
 * <p>Base URL: /api/v1/accounts</p>
 *
 * @see com.alaeldin.bank_simulator_service.service.BankAccountService
 */
@Slf4j
@RestController
...
public class BankAccountController {
     ...
     *
     * @param bankAccountService the service for bank account operations
     */
     ...
     * This endpoint returns a paginated list of all bank accounts in the system.
     *
     * <p>HTTP Method: GET</p>
     * <p>Endpoint: GET /api/v1/accounts</p>
     *
     ...
     *   <li>HTTP 400 Bad Request: Invalid pagination parameters (negative page or size < 1)</li>
     ...
     * </pre>
     *
     * <p>Example Response (HTTP 200):</p>
     * <pre>
     * {
     *   "content": [
     *     {
     *       "accountNumber": "AE202412345678",
    ...
    public ResponseEntity<Page<BankAccountResponse>> getAllBankAccounts(
        ...
        Page<BankAccountResponse> bankAccounts = bankAccountService.getAllAccounts(page, size);
    ...
    public ResponseEntity<Page<BankAccountResponse>> getBankAccountByHolderName(
        ...
        Page<BankAccountResponse> bankAccountResponse = bankAccountService.getAccountByHolderName(holderName, page, size);
    ...
    public ResponseEntity<Page<BankAccountResponse>> getBankAccountsByStatus(
